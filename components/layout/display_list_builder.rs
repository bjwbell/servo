...
fn handle_overlapping_radii(size: &Size2D<Au>, radii: &BorderRadii<Au>) -> BorderRadii<Au> {
    ...
    let left_factor = scale_factor(radii.top_left.width, radii.bottom_left.width, size.height);
    let right_factor = scale_factor(radii.top_right.width, radii.bottom_right.width, size.height);
